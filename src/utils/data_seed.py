...
def seed_data():
    ...
    if not user:
        user1 = UsersModel(id="e6af78d6-3bed-4a8b-8498-d7bcedf3bfb0",first_name="Hasan", last_name="Erdal",username="deneme",email="test@test.com",password_hash="e10adc3949ba59abbe56e057f20f883e", role=Roles.admin)
